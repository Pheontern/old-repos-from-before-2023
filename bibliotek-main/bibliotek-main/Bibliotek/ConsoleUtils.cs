    ...
    public static class ConsoleUtils
    {
        ...
        public static uint Menu(int aniSpeed, bool reverse, string title, params string[] menuChoices)
        {
            ...
            while (true)
            {
                ...
                {
                    AniWrite("Skriv endast ett tal 1 - " + numAlts + ".", 15, true);
                    Thread.Sleep(1000);
                }
        ...
        public static void AniWrite(string text, int time = 30/*tid i ms mellan varje tecken*/, bool reverse = false, int charStart = 1/*Tecknet att starta med,*/, bool cursor = true)
        {
        ...
        //Animerad banners, ganska oanvändbar eftersom man ändå inte kan skriva mer än en del åt gången... Använd inte.
        ...
        //Räknar antalet av en specifik substring i en string.
        public static int CountSubstrings(string source, string sub)
        {
        ...
        //Returnerar minsta talet som inte är negativt.
        public static int SmallestNonNegative(int a, int b)
        {
        ...
        public static string ReadInput(string question = "Input: ")
        {
            string answer;
            while (true)
            {
                ...
                if (answer != "") break;
                else Console.WriteLine("Du skrev inte in något! \n");
            }
            return answer;
        }
